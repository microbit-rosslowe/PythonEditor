  ...
  return new Promise(async function(resolve, reject){
    ...
    try {
      ...
      page.on('dialog', async dialog => {
        ...
        else if (dialog.message().includes("makecode")) testStates["invalid-test"] = true; // Pass of second test, that we get an error dialog when loading an invalid (makecode) hex file
        await dialog.accept();
      });
